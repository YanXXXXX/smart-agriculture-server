...
public class EmployeeServiceImpl implements IEmployeeService
{
    ...
    public int insertEmployee(Employee employee)
    {
        ...
        employee.setTenantId(SecurityUtils.getTenantId());
        employee.setBaseId(SecurityUtils.getBaseId());
        employee.setDeptId(SecurityUtils.getDeptId());
        employee.setUserId(SecurityUtils.getUserId());
