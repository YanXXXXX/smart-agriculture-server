...
public class MachineInfoServiceImpl implements IMachineInfoService 
{
    ...
    public int insertMachineInfo(MachineInfo machineInfo)
    {
        ...
        machineInfo.setTenantId(SecurityUtils.getTenantId());
        machineInfo.setBaseId(SecurityUtils.getBaseId());
        machineInfo.setDeptId(SecurityUtils.getDeptId());
        machineInfo.setUserId(SecurityUtils.getUserId());
