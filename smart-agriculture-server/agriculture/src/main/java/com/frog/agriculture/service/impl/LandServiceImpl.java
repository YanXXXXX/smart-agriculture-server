...
public class LandServiceImpl implements ILandService 
{
    ...
    public int insertLand(Land land)
    {
        ...
        land.setTenantId(SecurityUtils.getTenantId());
        land.setBaseId(SecurityUtils.getBaseId());
        land.setDeptId(SecurityUtils.getDeptId());
        land.setUserId(SecurityUtils.getUserId());
