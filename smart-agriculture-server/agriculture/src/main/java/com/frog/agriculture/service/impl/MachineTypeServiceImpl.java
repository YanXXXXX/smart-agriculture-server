...
public class MachineTypeServiceImpl implements IMachineTypeService 
{
    ...
    public int insertMachineType(MachineType machineType)
    {
        ...
        machineType.setTenantId(SecurityUtils.getTenantId());
        machineType.setBaseId(SecurityUtils.getBaseId());
        machineType.setDeptId(SecurityUtils.getDeptId());
        machineType.setUserId(SecurityUtils.getUserId());
