...
public class MaterialTypeServiceImpl implements IMaterialTypeService 
{
    ...
    public int insertMaterialType(MaterialType materialType)
    {
        ...
        materialType.setTenantId(SecurityUtils.getTenantId());
        materialType.setBaseId(SecurityUtils.getBaseId());
        materialType.setDeptId(SecurityUtils.getDeptId());
        materialType.setUserId(SecurityUtils.getUserId());
