...
public class MaterialInfoServiceImpl implements IMaterialInfoService 
{
    ...
    public int insertMaterialInfo(MaterialInfo materialInfo)
    {
        ...
        materialInfo.setTenantId(SecurityUtils.getTenantId());
        materialInfo.setBaseId(SecurityUtils.getBaseId());
        materialInfo.setDeptId(SecurityUtils.getDeptId());
        materialInfo.setUserId(SecurityUtils.getUserId());
