...
public class GermplasmServiceImpl implements IGermplasmService
{
    ...
    public int insertGermplasm(Germplasm germplasm)
    {
        ...
        germplasm.setTenantId(SecurityUtils.getTenantId());
        germplasm.setBaseId(SecurityUtils.getBaseId());
        germplasm.setDeptId(SecurityUtils.getDeptId());
        germplasm.setUserId(SecurityUtils.getUserId());
